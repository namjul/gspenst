...
export type ThemeConfigNodeFragment = {
  __typename: 'Config'
  id: string
  _values: any
  _sys: {
...
export function getSdk<C>(requester: Requester<C>) {
  return {
    ...
    getTags(
      ...
      return requester<
        { data: GetTagsQuery; variables: GetTagsQueryVariables; query: string },
        GetTagsQueryVariables
      >(GetTagsDocument, variables, options)
    },
    config(
